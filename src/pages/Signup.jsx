...
<div className= "bg-slate-100 h-full flex content-center">
    <div className="flex flex-col justify-between m-auto mt-8 p-3 w-4/5 bg-white  mb-5 md:flex-row rounded-md">
        <div className="bg-purple-400 p-5 rounded-md md:w-1/2">
        ...
        <p>Your journey to a more organized life starts here. Say goodbye to chaos and hello to productivity, 
            discover a new level of efficiency. Signing Up is quick and easy, takes less than 5 minutes to complete.</p>
        </div>
        ...
        <div className="p-5 mt-5 md:mt-0 md:ml-7 md:w-1/2 ">
            ...
            <form action="" className="flex flex-col">
                ...
                <input type="text" id="name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-300 focus:border-black block w-full p-2.5" required/>
                <p></p>
                </span>
                
                <span className="flex flex-col mb-5">
                <label htmlFor="email" className="block mb-2 text-sm font-medium">Email</label>
                <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-300 focus:border-black block w-full p-2.5" required/>
                <p></p>
                </span>
                
                <span className="flex flex-col mb-5">
                <label htmlFor="password" className="block mb-2 text-sm font-medium">Your password</label>
                <input type="password" id="password" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-300 focus:border-black block w-full p-2.5" required/>
                <p></p>
                </span>

                <span className="flex flex-col mb-5">
                <label htmlFor="repeat-password" className="block mb-2 text-sm font-medium text-gray-900 ">Repeat password</label>
                <input type="password" id="repeat-password" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-300 focus:border-black block w-full p-2.5" required/>
                </span>
